...
namespace Links
{
    ...
    public static class Scripts {
        ...
        public static class Site {
            ...
            public static string Url() { return T4MVCHelpers.ProcessVirtualPath(URLPATH); }
            public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(URLPATH + "/" + fileName); }
            public static readonly string AsociateProvider_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/AsociateProvider.min.js") ? Url("AsociateProvider.min.js") : Url("AsociateProvider.js");
    ...
    public static partial class Bundles
    {
        public static partial class Scripts 
        {
            ...
            public static partial class Site 
            {
                public static class Assets
                {
                    public const string AsociateProvider_js = "~/Scripts/Site/AsociateProvider.js"; 

namespace Crawler.Manager.Models
{
    public static class Constants
    {
        ...
        public const string C_SettingsModuleName = "Crawler";
        ...
        public const string C_Settings_CrawlerUrl_DetailInfo_ExperienceActivities = "CrawlerUrl_DetailInfo_ExperienceActivities";

        public const string C_Settings_CrawlerUrl_DetailInfo_Balance = "CrawlerUrl_DetailInfo_Balance";
